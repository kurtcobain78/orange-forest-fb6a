...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/orange-forest-fb6a)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/orange-forest-fb6a
```

A live public deployment of this template is available at [https://orange-forest-fb6a.templates.workers.dev](https://orange-forest-fb6a.templates.workers.dev)
